...
<div style="width: 750px;padding: 0 60px;font-size: 16px;box-sizing: border-box;margin: 0 auto;">
    <div style="color: #35313f;line-height: 30px;">
        <p style="font-size: 18px;margin-top: 30px;margin-bottom: 23px;">欢迎来到企保大师</p>
        <p>亲爱的用户<#if name??>，${name}</#if>：</p>
        <p style="height: 200px;margin-top: -15px;margin-bottom: 46px;">
            ${content}
        </p>
        <p style="text-align: right;">企保大师团队</p>
    ...
    <div style="color: #b1afbb;border-top: 1px solid #e9e9f4;border-bottom: 1px solid #e9e9f4;">
        <p style="line-height: 30px;">
            本邮件是用户注册企保大师后系统自动发出，如果你并未注册企保大师，可能是因为其他用户误输入了你的邮箱地址而使你收到这封邮件，你可以忽略此邮件。</p>
    </div>
