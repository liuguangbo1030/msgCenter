...
import com.msg.mc.service.impl.helper.AgentMessageHelper;
...
public class AgentMessageServiceImpl implements IMessageService {

    private Logger logger = LoggerFactory.getLogger(AgentMessageServiceImpl.class);
    /**
     * 参保公司发标
     */
    ...
    @Autowired
    private AgentMessageHelper messageHelper;
    ...
    public void processMessage(Message message) {
        ...
        String emailTmp = "qbds_email.ftl";
        try {
            switch (message.getId().intValue()) {
                ...
                case TYPE_UPDATE_TENDER:
                    ...
                    break;
                case TYPE_COINSURANCE:
                    map = messageHelper.coinsurance(tenders.getTenderName(), tenders.getTendkey());
                    break;
